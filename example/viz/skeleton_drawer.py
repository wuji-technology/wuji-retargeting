...
class SkeletonDrawer:
    ...
    def _build_robot_link_ids(self):
        ...
        # Find MANO-frame body (base_link if present, else fall back to palm).
        # Some Wuji hand URDFs expose an explicit base_link wrapping palm_link
        # (world / MANO-aligned); others only ship palm_link which is itself
        # MANO-aligned. Try the most-specific name first.
        for name in (
