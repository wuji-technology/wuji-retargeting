"""
Input Data Replay device for teleoperation.
Replays recorded raw input data (MediaPipe format).
...
This device replays the original input data, allowing retargeting to be
re-run with different parameters for debugging purposes.
"""
...
class InputDataReplay(InputDeviceBase):
    """Replay recorded raw input data (MediaPipe format)."""
